...
A regular expression or RegExp is a small programming language that helps to
...
_search()_: Tests for a match in a string. It returns the index of the match, or
