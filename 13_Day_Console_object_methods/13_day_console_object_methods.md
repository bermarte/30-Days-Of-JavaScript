...
In addition to the famous, console.log() method, the console provides other more
methods.
...
According the above output the regular for loop is slower than for of or forEach
loop.
