...
The following sections show different ways of adding JavaScript code to your web
page.
...
The first and second variables on the list follows the camelCase convention of
